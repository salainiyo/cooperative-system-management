...
export default function EditMemberModal({ member, onClose, onSuccess }) {
  // We extract the YYYY-MM-DD part of the date for the HTML date input
  const defaultDate = member.date_of_birth ? member.date_of_birth.split('T')[0] : '';
      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-100">Edit Member</h2>
              <p className="text-slate-400 text-sm">Update member information</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input type="tel" name="phone_number" value={formData.phone_number} onChange={handleChange} className="input" required />
          </div>
